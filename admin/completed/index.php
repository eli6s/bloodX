...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="../">Completed Appointments</a></div>
            <div class="breadcrumb-item">Completed Appointments Details</div>
        </div>
    </div>
            ...
            <div class="col-12 ">
                <div class="card">
                    <div class="card-header  d-flex justify-content-between align-items-center">
                        <h4>Completed Appointment Details</h4>
                    </div>
                    <div class="card-body ">
                                    ...
                                    <?php if ($counter > 0) : ?>
                                        <?php foreach ($appointments as $appointment) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle"><?= setStatus('completed', $appointment['appointment_id']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
