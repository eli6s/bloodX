                    ...
                    <div class="card-header  d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown w-25">
                            <button class="btn btn-primary dropdown-toggle w-100" type="button" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?= isset($_GET['last']) && $_GET['last'] != 1 ? 'Last ' . $_GET['last'] . ' days' : 'Last 24 Hours' ?>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="filterDropdown">
                                <a class="dropdown-item" href="?last=1">Last 24 hours</a>
                                <a class="dropdown-item" href="?last=7">Last 7 days</a>
                                <a class="dropdown-item" href="?last=30">Last 30 days </a>
                                <a class="dropdown-item" href="?last=60">Last 60 days </a>
                                <a class="dropdown-item" href="?last=90">Last 90 days </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php if ($counter > 0) : ?>
                                        <?php foreach ($appointments as $appointment) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle"><?= setStatus($appointment["status_type"]); ?></td>
                                                <td class="align-middle"><?= diffHumans($appointment["updated_at"]) ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <tr class="">
