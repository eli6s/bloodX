...
<section class="section">
    <div class="section-header">
        ...
        <h1>Waiting List of Appointments </h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="../">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="../">Waiting List of Appointments</a></div>
            <div class="breadcrumb-item">Appointments Details</div>
        </div>
    </div>
                            ...
                            <table class="table table-sm table-striped " id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="py-3">Appointment at</th>
                                    ...
                                    <?php if ($counter > 0) : ?>
                                        <?php foreach ($appointments as $appointment) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle"><?= date("M d, Y - H:i A ", strtotime($appointment["appointment_at"])); ?></td>
